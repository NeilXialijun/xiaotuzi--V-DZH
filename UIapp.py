...
# @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    def The_winning_recognition(self, results):
        ...
        if isinstance(self.num_list2, str) is True:
            ...
            now_hour = datetime.datetime.now().hour
            now_minute = datetime.datetime.now().minute            
            if now_hour == 3 and now_minute > 14 and self.M_list[self.bet_count2] == 0:
        ...
        if isinstance(self.num_list3, str) is True:
            ...
            now_hour = datetime.datetime.now().hour
            now_minute = datetime.datetime.now().minute            
            if now_hour == 3 and now_minute > 14 and self.M_list[self.bet_count3] == 0:
        ...
        if isinstance(self.num_list4, str) is True:
            ...
            now_hour = datetime.datetime.now().hour
            now_minute = datetime.datetime.now().minute            
            if now_hour == 3 and now_minute > 14 and self.M_list[self.bet_count4] == 0:
        ...
        if isinstance(self.num_list5, str) is True:
            ...
            now_hour = datetime.datetime.now().hour
            now_minute = datetime.datetime.now().minute            
            if now_hour == 3 and now_minute > 14 and self.M_list[self.bet_count5] == 0:
        ...
        if isinstance(self.num_list6, str) is True:
            ...
            now_hour = datetime.datetime.now().hour
            now_minute = datetime.datetime.now().minute            
            if now_hour == 3 and now_minute > 14 and self.M_list[self.bet_count6] == 0:
        ...
        if isinstance(self.num_list7, str) is True:
            ...
            now_hour = datetime.datetime.now().hour
            now_minute = datetime.datetime.now().minute            
            if now_hour == 3 and now_minute > 14 and self.M_list[self.bet_count7] == 0:
        ...
        if isinstance(self.num_list8, str) is True:
            ...
            now_hour = datetime.datetime.now().hour
            now_minute = datetime.datetime.now().minute            
            if now_hour == 3 and now_minute > 14 and self.M_list[self.bet_count8] == 0:
